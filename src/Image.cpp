...
bool Image::indexValid(const int &row, const int &column,
...
int Image::getChannel(const int &row, const int &column,
                      const int &channel) const {
...
void Image::setChannel(const int &row, const int &column, const int &channel,
                       const int &value) {
  if (indexValid(row, column, channel)) {
